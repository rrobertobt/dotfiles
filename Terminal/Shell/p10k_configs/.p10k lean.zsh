...
() {
  ...
  #'✔' '%B[%b%B]%b'  ❮❯   []
  typeset -g POWERLEVEL9K_STATUS_OK_VISUAL_IDENTIFIER_EXPANSION='%B%F{blue}[ %f%F{green}%b%B%f%F{blue} ]%f%b'
  ...
  # 
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_VISUAL_IDENTIFIER_EXPANSION='%B%F{blue}[ %f%F{green}%bﲖ %B%f%F{blue} ]%f%b'
  ...
  #'✘' ''
  typeset -g POWERLEVEL9K_STATUS_ERROR_VISUAL_IDENTIFIER_EXPANSION='%B%F{blue}[ %f%F{red}%b%B%f%F{blue} ]%f%b'
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_SIGNAL_VISUAL_IDENTIFIER_EXPANSION='%B%F{blue}[ %f%F{red} %f%F{blue} ]%f%b'

  # Status when some part of a pipe command fails and the overall exit status is also non-zero.
  # It may look like this: 1|0.
  typeset -g POWERLEVEL9K_STATUS_ERROR_PIPE=true
  typeset -g POWERLEVEL9K_STATUS_ERROR_PIPE_FOREGROUND=1
  typeset -g POWERLEVEL9K_STATUS_ERROR_PIPE_VISUAL_IDENTIFIER_EXPANSION='%B%F{blue}[ %f%F{red}ﲒ %f%F{blue} ]%f%b'
