# Generated by Powerlevel10k configuration wizard on 2020-10-21 at 15:58 MDT.
...
# 24h time, 1 line, sparse, many icons, concise, transient_prompt, instant_prompt=quiet.
...
# | |\ \  | |_| |                                       #
# |_| \_\ |_____/    My p10k config file (lean style)   #
#                                                       #
#########################################################


#########################################################
# !!! Requires a nerdfont to display all the icons !!!  #
#########################################################
...
() {
  ...
  #'✔' '%B[%b%B]%b'  ❮❯   []
  typeset -g POWERLEVEL9K_STATUS_OK_VISUAL_IDENTIFIER_EXPANSION='%B%F{7}[ %f%F{green}%b%B%f%F{7} ]%f%b'
  ...
  # 
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_VISUAL_IDENTIFIER_EXPANSION='%B%F{7}[ %f%F{green}%bﲖ %B%f%F{7} ]%f%b'
  ...
  #'✘' ''
  typeset -g POWERLEVEL9K_STATUS_ERROR_VISUAL_IDENTIFIER_EXPANSION='%B%F{7}[ %f%F{red}%b%B%f%F{7} ]%f%b'
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_SIGNAL_VISUAL_IDENTIFIER_EXPANSION='%B%F{7}[ %f%F{red} %f%F{7} ]%f%b'

  # Status when some part of a pipe command fails and the overall exit status is also non-zero.
  # It may look like this: 1|0.
  typeset -g POWERLEVEL9K_STATUS_ERROR_PIPE=true
  typeset -g POWERLEVEL9K_STATUS_ERROR_PIPE_FOREGROUND=1
  typeset -g POWERLEVEL9K_STATUS_ERROR_PIPE_VISUAL_IDENTIFIER_EXPANSION='%B%F{7}[ %f%F{red}ﲒ %f%F{7} ]%f%b'
  ...
  # Format for the current time: (%H)09:(%M)51:(%S)02. See `man 3 strftime`.
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_LAST_SEGMENT_END_SYMBOL=' %B%F{yellow}[%f%b'
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_FIRST_SEGMENT_START_SYMBOL='%B%F{yellow}]%f%b '
  unset POWERLEVEL9K_PROMPT_CHAR_LEFT_PROMPT_LAST_SEGMENT_END_SYMBOL
