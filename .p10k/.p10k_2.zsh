# Generated by Powerlevel10k configuration wizard on 2021-04-24 at 22:43 CST.
...
() {
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local       meta='%B%0F'  # grey foreground
      local      clean='%B%10F'   # green foreground
      local   modified='%B%11F'  # yellow foreground
  ...
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_TEMPLATE='as %B%n@%m'
  ...
  # Custom prefix.
  # typeset -g POWERLEVEL9K_CONTEXT_PREFIX='%244Fin'
